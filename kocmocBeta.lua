...
for i,v in next, workspace.Decorations.Misc:GetDescendants() do if v.Parent.Name == "Mushroom" or string.find(v.Name, "Blue Flower") then v.CanCollide = false v.Transparency = 0.5 end end
